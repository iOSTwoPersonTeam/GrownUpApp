...
- (UICollectionView*)collectionView
{
    if (_collectionView == nil) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth, KScreenHeight -64-49-40) collectionViewLayout:flowLayout];
...
- (UIButton*)liveButton
{
    if (_liveButton == nil) {
        ...
        _liveButton.frame = CGRectMake(KScreenWidth - 75, KScreenHeight/2, 60, 60);
