...
@interface TDHomeRecommendModel : NSObject
...
@interface XMLYFindEditorRecommendAlbumModel : NSObject
 ...
 *  精品听单模型
 */
@interface XMLYSpecialColumnModel : NSObject
 ...
 *  精品订单详情模型
 */
@interface XMLYSpecialColumnDetailModel : NSObject
 ...
 *  轮播图模型 存储数组
 */
@interface XMLYFindFocusImagesModel : NSObject
 ...
 *  轮播图详情数组
 */
@interface XMLYFindFocusImageDetailModel : NSObject
...
@interface XMLYFindEditorRecommendDetailModel : NSObject
/**
 *  唯一标识
 */
@property (nonatomic, assign) NSInteger  cid;
